...
def create_db(): #создание базы данных
...
def read_db(complete_line): #запись спарсенных коэффициентов в базу данных
        ...
        for nomination in line:
            for nominee in line[nomination]:
                ...
                if nom_id is None:
                    ...
                    nom_id = nom_id[0]
                coef_data = (nom_id, nominee, line[nomination][nominee], curent_time )
